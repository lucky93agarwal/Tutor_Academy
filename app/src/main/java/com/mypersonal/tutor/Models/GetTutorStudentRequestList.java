...
public class GetTutorStudentRequestList {
    ...
    public void setTuition_type(String tuition_type) {
        this.tuition_type = tuition_type;
    }

    public String getWilling_to_traveling() {
        return willing_to_traveling;
    }

    public void setWilling_to_traveling(String willing_to_traveling) {
        this.willing_to_traveling = willing_to_traveling;
    }
    ...
    public String getReq_subjects() {
        return req_subjects;
    }

    public void setReq_subjects(String req_subjects) {
        this.req_subjects = req_subjects;
    }

    public String getReq_timing() {
        return req_timing;
    }

    public void setReq_timing(String req_timing) {
        this.req_timing = req_timing;
    }
