...
public class StudentListNewAdapter extends RecyclerView.Adapter<StudentListNewAdapter.ViewHolder> {
    public static Context mcontext;

    public boolean run = false;
    public static List<GetRequestList> productList;
    public static boolean runtimer = true;
    public Context context;
    ViewHolder view;

    public GetRequestList getselfdata;
    String Contest = "";


    ViewHolder viewHolder;

    public StudentListNewAdapter(Context context, List<GetRequestList> productList) {
        super();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.top_new_course_cell, viewGroup, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder  {
        ...
        public ViewHolder(final View itemView) {
            ...
            itemView.findViewById(R.id.newid).setVisibility(View.GONE);
