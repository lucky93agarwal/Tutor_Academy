...
public class RequestMessageLsitAdapter extends RecyclerView.Adapter<RequestMessageLsitAdapter.ViewHolder> {
    ...
    public RequestMessageLsitAdapter(Context context, List<GetStudentRequestList> productList) {
        super();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.top_new_course_cell_msg, viewGroup, false);
