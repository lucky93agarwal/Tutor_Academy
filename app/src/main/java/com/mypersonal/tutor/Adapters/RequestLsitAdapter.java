...
public class RequestLsitAdapter extends RecyclerView.Adapter<RequestLsitAdapter.ViewHolder> {
    ...
    public RequestLsitAdapter(Context context, List<GetRequestList> productList) {
        super();
