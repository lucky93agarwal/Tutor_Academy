...
public class YourMessageListAdapter extends RecyclerView.Adapter<YourMessageListAdapter.ViewHolder> {
    public static Context mcontext;

    public boolean run = false;
    public static List<getMsgTutor> productList;
    public static boolean runtimer = true;
    public Context context;
    ViewHolder view;

    public getMsgTutor getselfdata;
    String Contest = "";


    ViewHolder viewHolder;

    public YourMessageListAdapter(Context context, List<getMsgTutor> productList) {
        super();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.top_new_course_cell_new_new, viewGroup, false);
...
//        }
        ...
        if(productList.get(i).getStatus_msg().equalsIgnoreCase("1")){
            viewHolder.tvrequest_time.setText("Replay Message:  "+productList.get(i).getReq_msg());
        }


        viewHolder.tvsubject.setText("Subject: "+productList.get(i).getWeak_subjects());
        viewHolder.tvname.setText(""+productList.get(i).getStudent_name());
...
//            });
            ...
            mcardview.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("name",productList.get(getAdapterPosition()).getStudent_name());
                    intent.putExtra("fee","");
            ...
            tvicon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(mcontext, StudentDetailsActivity.class);
                    intent.putExtra("image",productList.get(getAdapterPosition()).upload_pic);
                    intent.putExtra("name",productList.get(getAdapterPosition()).student_name);
                    intent.putExtra("fee","");
                    intent.putExtra("current_location",productList.get(getAdapterPosition()).current_location);
