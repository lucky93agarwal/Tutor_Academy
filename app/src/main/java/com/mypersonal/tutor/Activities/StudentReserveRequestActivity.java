...
public class StudentReserveRequestActivity extends AppCompatActivity {
...
//                onChangeSelectedReceivers();
    ...
    private void sendrequest() {
        ...
        service.request_tutor_list(request).enqueue(new Callback<RequestResponseJson>() {
            @Override
            public void onResponse(Call<RequestResponseJson> call, retrofit2.Response<RequestResponseJson> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().status.equalsIgnoreCase("0")) {
                        Toast.makeText(StudentReserveRequestActivity.this, "Invalid Credentials", Toast.LENGTH_SHORT).show();
                    } else {

                        Toast.makeText(StudentReserveRequestActivity.this, "your request has been submitted successfully.", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    switch (response.code()) {
                        case 401:
                            Toast.makeText(StudentReserveRequestActivity.this, "email and pass not check", Toast.LENGTH_SHORT).show();
                            break;
                        case 403:
                            Toast.makeText(StudentReserveRequestActivity.this, "ForbiddenException", Toast.LENGTH_SHORT).show();
                            break;
                        case 404:
                            Toast.makeText(StudentReserveRequestActivity.this, "not found", Toast.LENGTH_SHORT).show();
                            break;
                        case 500:
                            Toast.makeText(StudentReserveRequestActivity.this, "server broken", Toast.LENGTH_SHORT).show();
                            break;
                        default:
                            Toast.makeText(StudentReserveRequestActivity.this, "unknown error", Toast.LENGTH_SHORT).show();
                            break;

                    }
                    Toast.makeText(StudentReserveRequestActivity.this, "Something error please try again", Toast.LENGTH_SHORT).show();
            ...
            public void onResponse(Call<SubjectResponseJson> call, Response<SubjectResponseJson> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.body().status.equalsIgnoreCase("0")) { ////New App
                        ...
                        Toast.makeText(StudentReserveRequestActivity.this, "Techincal problem. Please contact the admistrator", Toast.LENGTH_SHORT).show();
