...
import com.mypersonal.tutor.Fragments.TutorAccountFragment;
import com.mypersonal.tutor.Fragments.TutorMessageListFragment;
import com.mypersonal.tutor.Fragments.TutorRequestFragment;
import com.mypersonal.tutor.Fragments.TutorStudentListFragment;
...
import com.mypersonal.tutor.Models.DifficultyLevel;
import com.mypersonal.tutor.Models.Language;
import com.mypersonal.tutor.Models.Price;
import com.mypersonal.tutor.Models.Rating;
...
public class TutorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        addpopup = new msgreplypopup(TutorActivity.this);

        getSystemSettings();
        // Activating Course Fragment while the application runs for the first time
        getSupportFragmentManager().beginTransaction().replace(R.id.homePageFrameLayout, new TutorStudentListFragment()).commit();
    ...
    private void filterCourse() {
        ...
        call.enqueue(new Callback<List<CourseSchema>>() {
            ...
            public void onResponse(Call<List<CourseSchema>> call, Response<List<CourseSchema>> response) {
                ...
                Intent intent = new Intent(TutorActivity.this, CoursesActivity.class);
            ...
            public void onFailure(Call<List<CourseSchema>> call, Throwable t) {
                Toast.makeText(TutorActivity.this, "Some error occurred", Toast.LENGTH_SHORT).show();
            }
        });
...
//        filterCourse();
    ...
    public void msgreply(String status,String id,String message){
        addpopup.addpopup(id,message);
    }
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                    ...
                    switch (menuItem.getItemId()){
                        ...
                        case R.id.navigation_course:
                            filterButton.hide();
                            selectedFragment = new TutorStudentListFragment();
                            break;
                        case R.id.navigation_my_course:
                            filterButton.hide();
                            selectedFragment = new TutorRequestFragment();
                            break;
                        case R.id.navigation_wishlist:
                            filterButton.hide();
                            selectedFragment = new TutorMessageListFragment();
                            break;
                        case R.id.navigation_account:
                            filterButton.hide();
                            selectedFragment = new TutorAccountFragment();
                            break;
                    }
