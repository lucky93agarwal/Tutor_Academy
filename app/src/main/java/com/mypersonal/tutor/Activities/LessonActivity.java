...
import com.mypersonal.tutor.Adapters.LessonAdapter;
import com.mypersonal.tutor.Adapters.SectionAdapter;
import com.mypersonal.tutor.JSONSchemas.CourseSchema;
import com.mypersonal.tutor.JSONSchemas.LessonCompletionSchema;
import com.mypersonal.tutor.JSONSchemas.LessonSchema;
...
import com.mypersonal.tutor.Utils.VideoConfig;
...
public class LessonActivity extends YouTubeBaseActivity implements SectionAdapter.PassLessonToActivity {
    ...
    private void playYouTubeVideo(final String videoUrl) {
        ...
        youtubePlayer.initialize(VideoConfig.getApiKey(), mOnInitializedListener);
    }
